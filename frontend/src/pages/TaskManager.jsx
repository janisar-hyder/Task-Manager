...
import { LayoutList, Sparkles, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 relative overflow-hidden flex flex-col items-center">
            ...
            <main className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 flex flex-col gap-8">
                <div className="absolute top-4 left-4 sm:top-8 sm:left-8 z-20">
                    <Link to="/" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-500 hover:text-indigo-600 bg-white/50 backdrop-blur-md hover:bg-white rounded-full transition-all border border-slate-200/60 shadow-sm">
                        <ArrowLeft size={16} />
                        Back to Home
                    </Link>
                </div>
                ...
                <motion.header
                    ...
                    className="flex flex-col items-center text-center space-y-4 mb-4 mt-8"
                >
